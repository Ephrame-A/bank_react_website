...
<div className="flex flex-row justify-between items-center w-full">
  ...
  ss:text-[72px] ss:leading-[100px] text-[52px] text-white'>
...
<h1 className='flex-1 font-poppins font-semibold 
  ss:text-[68px] ss:leading-[100px] leading-[75px] text-[52px]
   text-white w-full'>Payment Method.</h1>
   <p className={`styles.paragraph} max-w-[470px] mt-5`}>Our team of experts uses a methodology to 
    identify the creadit cards most likely to fit your needs. 
